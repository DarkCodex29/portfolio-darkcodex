...
export const ThemeToggle = memo(() => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed z-[200] bg-black/40 backdrop-blur-xl border border-white/10 rounded-full hover:bg-black/60 transition-all duration-300 hover:scale-110 active:scale-95 shadow-lg"
      style={{
        bottom: 'var(--space-6)',
        right: 'var(--space-6)',
        width: 'var(--icon-2xl)',
