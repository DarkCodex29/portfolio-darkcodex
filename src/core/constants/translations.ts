export const TRANSLATIONS = {
  es: {
    ...
    windows: {
      ...
      experience: {
        title: 'Experiencia — Safari',
        header: 'Experiencia Profesional',
        timeline: 'Timeline',
        companies: 'Empresas',
        present: 'Presente',
        yearsInEnterprise: '+6 años en desarrollo enterprise',
      },
      gallery: {
        title: 'Galería — Photos',
        header: 'Galería de Proyectos',
        categories: 'Categorías',
        all: 'Todas',
        mobile: 'Mobile',
        web: 'Web',
        enterprise: 'Enterprise',
        screenshotsCount: 'screenshots de proyectos',
  ...
  en: {
    ...
    windows: {
      ...
      experience: {
        ...
        companies: 'Companies',
        present: 'Present',
        yearsInEnterprise: '+6 years in enterprise development',
      },
      gallery: {
        ...
        web: 'Web',
        enterprise: 'Enterprise',
        screenshotsCount: 'project screenshots',
